...
use App\Http\Controllers\KuponumumController;
...
Route::middleware(['auth'])->group(function () {
    ...
    // ini yang saya
    Route::get('/kuponumum/belum-scan', [KuponumumController::class, 'belumScan'])->name('kuponumum.belum');
    Route::get('/kuponumum/sudah-scan', [KuponumumController::class, 'sudahScan'])->name('kuponumum.sudah');
    // Route resource untuk Kupon Umum (CRUD)
    Route::resource('/kuponumum', KuponumumController::class);
    //
    Route::get('/kuponumum/print/{id}', [KuponUmumController::class, 'print'])->name('kuponumum.print');
