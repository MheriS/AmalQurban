...
<section class="section">
  ...
  <div class="section-body">
            ...
            <tbody>
              @forelse ($kuponumums as $kuponumum)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('kuponumum.print', $kuponumum->id) }}" class="btn btn-sm btn-info" target="_blank">
    ...
    <div class="row mt-3">
      {{-- Info kiri --}}
      <div class="col-md-6 col-12 mb-2 mb-md-0 text-md-left text-center">
        Menampilkan {{ $kuponumums->firstItem() }}&ndash;{{ $kuponumums->lastItem() }} dari total {{ $kuponumums->total() }} entri
      </div>
